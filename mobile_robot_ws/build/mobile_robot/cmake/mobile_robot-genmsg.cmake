...
message(STATUS "mobile_robot: 0 messages, 1 services")
...
get_filename_component(_filename "/home/vboxuser/mobile_robot_ws/src/mobile_robot/srv/amclPose.srv" NAME_WE)
add_custom_target(_mobile_robot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mobile_robot" "/home/vboxuser/mobile_robot_ws/src/mobile_robot/srv/amclPose.srv" ""
)
...
_generate_srv_cpp(mobile_robot
  "/home/vboxuser/mobile_robot_ws/src/mobile_robot/srv/amclPose.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mobile_robot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mobile_robot\")")
  # install generated code
  install(
